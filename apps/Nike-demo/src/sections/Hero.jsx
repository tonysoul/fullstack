...
const Hero = () => {
  return (
    <section id="hero">
      <div className="max-container flex min-h-screen flex-col justify-between xl:lg:flex-row">
        <div className="flex flex-col px-6 pt-28 lg:w-full xl:w-1/2">
        ...
        <div className="bg-hero space-y-5 flex flex-1 flex-col items-center justify-center bg-purple-50 bg-cover bg-center">
          <img
