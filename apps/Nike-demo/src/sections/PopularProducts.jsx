        ...
        <div className="px-6 py-24">
          ...
          <div className="flex justify-between">
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-2xl font-semibold">Nike Air Jordan-01</h3>
            ...
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-2xl font-semibold">Nike Air Jordan-10</h3>
            ...
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-2xl font-semibold">Nike Air Jordan-100</h3>
            ...
            <div className="flex flex-col gap-4">
              ...
              <h3 className="text-2xl font-semibold">Nike Air Jordan-1000</h3>
